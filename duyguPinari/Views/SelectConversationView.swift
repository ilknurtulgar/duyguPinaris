            ...
            VStack(spacing: 0){
                ...
                ScrollView{
                    VStack(spacing: 35){
                        ...
                        FeedbackCard(profileImage: Image(systemName: "person.circle"), name: "Alexa Richardson", role:"Listener", rating: 3, feedbackText:  "I'm a mobile app developer who loves creating meaningful digital experiences. Passionate about iOS development and always eager to learn new things. In my free time, I enjoy coding, reading about tech innovations, and connecting with people through creative projects.")
                        VStack(alignment: .leading,spacing: 15){
                            TextStyles.subtitleMedium2("Geribildirimler:")
                            FeedbackCard(profileImage: Image(systemName: "person.circle"), name: "John Doe", role: "Listener", rating: 4, feedbackText: "Fantastic insights. Thank you for your support!")
